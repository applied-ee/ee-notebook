...
2. **Shorts check** — Measure resistance across the power rail(s) near the repair area. Compare to the expected value — a dead short means something is still wrong. If this wasn't measured before the repair, that's a lesson for next time
