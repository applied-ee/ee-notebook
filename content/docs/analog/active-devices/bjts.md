...
The small-signal model is a linear circuit that can be analyzed with all the standard techniques (superposition, Thevenin, KVL/KCL). This is where the [Fundamentals]({{< relref "/docs/fundamentals" >}}) section connects directly to analog design.
