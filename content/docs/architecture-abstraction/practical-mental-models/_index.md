...
- **[Abstraction Smells]({{< relref "abstraction-smells" >}})** — Patterns that suggest you're using the wrong abstraction, relying on a broken one, or missing a level entirely.
