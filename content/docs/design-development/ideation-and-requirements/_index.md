...
- **[Power Source Selection]({{< relref "power-source-selection" >}})** — Choosing between mains, USB, batteries, and harvesting — and sizing the supply to match the load.
...
- **[Knowing When Not to Build]({{< relref "knowing-when-not-to-build" >}})** — Evaluating whether custom hardware is the right answer at all.
