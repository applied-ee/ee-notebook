...
- **[Is it within tolerance?]({{< relref "within-tolerance" >}})** — Comparing measured value to rated value and tolerance band. Drift from aging, heat damage, or overstress.
- **[What's the ESR / leakage / gain?]({{< relref "esr-leakage-gain" >}})** — Deeper characterization beyond nominal value. Electrolytic ESR, capacitor leakage current, transistor hFE, and other parameters that separate a marginal part from a good one.
